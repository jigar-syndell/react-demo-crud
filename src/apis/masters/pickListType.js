...
export const createPickListType = async (payload) => {
    try {
     const  {data} = await axios.post(`${url}/pickListType`,payload,jsonconfig);
      return data;
    } catch (error) {
      return { success: false, error: error.response };
    }
...
export const updatePickListType = async (payload) => {
    try {
     const  {data} = await axios.put(`${url}/pickListType/${payload.id}`, payload.data,jsonconfig);
      return data;
    } catch (error) {
      return { success: false, error: error.response };
    }
...
export const deletePickListType = async (id) => {
    try {
     const  {data} = await axios.delete(`${url}/pickListType/${id}`,jsonconfig);
      return data;
    } catch (error) {
      return { success: false, error: error.response };
    }
